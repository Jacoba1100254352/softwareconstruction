...
public class ServerTests
{
	...
	@NotNull
	private static chess.gameplay.ChessGame getChessGame(chess.gameplay.ChessGame originalGame) throws chess.gameplay.InvalidMoveException {
		// Simulate a move to change the state of the game.
		chess.gameplay.ChessPosition startPosition = new ChessPositionImpl(2, 5);
		chess.gameplay.ChessPosition endPosition = new ChessPositionImpl(4, 5);
	...
	public void claimSpotPass() throws DataAccessException {
		...
		// Claim a spot
		gameDAO.claimSpot(game.getGameID(), testUser, chess.gameplay.ChessGame.TeamColor.WHITE);
	...
	public void claimSpotFail() throws DataAccessException {
		...
		gameDAO.insertGame(game);
		Assertions.assertThrows(DataAccessException.class, () -> gameDAO.claimSpot(game.getGameID(), secondPlayer, chess.gameplay.ChessGame.TeamColor.WHITE));
	}
	...
	public void updateGamePass() throws DataAccessException, InvalidMoveException {
		...
		// Setup game
		chess.gameplay.ChessGame originalGame = new ChessGameImpl();
		originalGame.getBoard().resetBoard();
		originalGame.setTeamTurn(chess.gameplay.ChessGame.TeamColor.WHITE);
		...
		chess.gameplay.ChessGame newGame = getChessGame(originalGame);
